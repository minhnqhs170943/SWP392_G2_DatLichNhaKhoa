...
const PaymentQRPage = () => {
    ...
    useEffect(() => {
        if (location.state?.paymentData) {
            ...
            const cleanup = startCheckingPayment(location.state.paymentData.orderId);
    ...
    const startCheckingPayment = (orderId) => {
        const successTimer = setTimeout(() => {
            navigate(`/payment/success?orderCode=${orderId}`);
        }, 20000);
            ...
            <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '30px' }}>
                    ...
                    <p style={{ 
                        ...
                        Mã đơn hàng: <strong>#{paymentData.orderId}</strong>
                    </p>
                </div>
                ...
                {/* Trạng thái checking - Xóa vì gây giật */}
